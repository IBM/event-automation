...
**Note:** This issue does not occur if using an {{site.data.reuse.ep_name}} instance configured without persistent storage, nor when importing flows exported to **JSON** format from earlier versions of {{site.data.reuse.ep_name}}.
