...
To help users prepare their clients for the move to Kafka 4.0.x, the {{site.data.reuse.egw}} reports if any clients are calling the deprecated APIs and presents a warning message in the {{site.data.reuse.eem_name}} UI.
