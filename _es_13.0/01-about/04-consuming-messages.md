...
Many more configuration settings are available, but ensure you read the [Apache Kafka documentation](https://kafka.apache.org/42/documentation.html){:target="_blank"} thoroughly before experimenting with them.
