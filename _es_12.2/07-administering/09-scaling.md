...
- Automatic scaling: In {{site.data.reuse.es_name}} 12.2.0 and later, you can enable [auto-scaling](#auto-scaling-kafka-brokers), which is supported only for Kafka brokers.
...
For more information about scaling up Kafka node pools, see the [Strimzi documentation](https://strimzi.io/docs/operators/0.50.1/deploying#proc-scaling-up-node-pools-str){:target="_blank"}. 
...
**Note:** Only a [selected subset](https://strimzi.io/docs/operators/0.50.1/configuring.html#con-common-configuration-jvm-reference){:target="_blank"} of the available JVM options can be configured.
