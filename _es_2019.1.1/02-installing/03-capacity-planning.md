...
When preparing for your {{site.data.reuse.es_name}} installation, consider the capacity requirements for your system<!--, including the disk space required for persistent volumes, and the memory and CPU resource limits for your Kafka brokers and geo-replicator containers-->.
