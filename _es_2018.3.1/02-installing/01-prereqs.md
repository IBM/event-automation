...
{{site.data.reuse.es_name}} version | Container platform | Systems
----------------------|--------------------|-----------------------|-------------|--------------------
![Event Streams 2018.3.1 icon]({{ 'images' | relative_url }}/2018.3.1.svg "Event Streams 2018.3.1.") | {{site.data.reuse.icp}} 3.1.1 and 3.1.2  | - Linux® 64-bit (x86_64) systems <br/>- Linux on IBM® Z systems
...
![Event Streams 2018.3.1 icon]({{ 'images' | relative_url }}/2018.3.1.svg "Event Streams 2018.3.1.") has Helm chart version 1.1.0 and includes Kafka version 2.0.1.
...
To install the {{site.data.reuse.es_name}} chart, you must have the `ibm-restricted-psp` [PodSecurityPolicy](https://ibm.biz/cpkspec-psp) selected for the target namespace.
