...
- {{site.data.reuse.es_name}} version 10.3.1 includes Kafka release 2.6.2, and supports the use of all Kafka interfaces.
- {{site.data.reuse.es_name}} version 10.3.0 includes Kafka release 2.6.0, and supports the use of all Kafka interfaces.
