...
{{site.data.reuse.es_name}} uses OpenShift routes. Find out how to retrieve the URLs for your {{site.data.reuse.es_name}} UI and CLI. You can then use the appropriate URL to log in to your {{site.data.reuse.es_name}} instance.
