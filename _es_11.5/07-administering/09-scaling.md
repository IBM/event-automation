...
**Note:** Only a [selected subset](https://strimzi.io/docs/operators/0.44.0/configuring.html#con-common-configuration-jvm-reference){:target="_blank"} of the available JVM options can be configured.
