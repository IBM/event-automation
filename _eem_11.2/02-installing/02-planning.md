...
If you are [installing](../installing#installing-an-event-manager-instance-by-using-the-web-console) on the {{site.data.reuse.openshift_short}}, you can view and apply the following sample configurations in the web console:
...
This example installs a production-ready {{site.data.reuse.eem_manager}} instance, with persistence and using local authentication.
