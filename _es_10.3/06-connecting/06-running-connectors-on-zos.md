...
To start an individual connector use the [Kafka Connect REST API](https://kafka.apache.org/26/documentation/#connect_rest). For example, given a configuration file `mq-source.json` with the following contents:
```
{
    "name":"mq-source",
        "config" : {
