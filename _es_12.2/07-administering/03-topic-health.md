...
**Note:** To gather producer metrics and display them in the **Producers** dashboard, you must [enable the collection of producer metrics](../../installing/configuring/#enabling-collection-of-producer-metrics).
