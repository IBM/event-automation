...
## Symptoms
You are trying to [configure a client application to connect to a virtual topic](../../subscribe/configure-your-application-to-connect/#example-kcat-test). The client fails to connect and the logs include an unhandled exception similar to the following example:
