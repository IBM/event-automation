...
6. In the **Create EventStreamsGeoReplicator** page, edit the provided YAML to set values for the following properties.
  ...
  ![Create EventStreamsGeoReplicator](../../../images/georeplication_create_eventstreamsgeoreplicator.png "Screen capture showing the Create EventStreamsGeoReplicator page with completed YAML.")
7. Click **Create**.
