...
Create a namespace into which {{site.data.reuse.eem_name}} will be installed by creating a [project](https://docs.openshift.com/container-platform/4.16/applications/projects/working-with-projects.html){:target="_blank"}.
...
This adds the catalog source for {{site.data.reuse.eem_name}} to the OperatorHub catalog, making the operator available to install.
