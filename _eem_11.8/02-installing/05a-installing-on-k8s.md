...
Create a namespace for {{site.data.reuse.eem_name}}.
...
**Important:** Do not use any of the initial or system [namespaces](https://v1-35.docs.kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/#initial-namespaces){:target="_blank"} to install {{site.data.reuse.eem_name}}. For example: `default`, `kube-node-lease`, `kube-public`, and `kube-system`.
