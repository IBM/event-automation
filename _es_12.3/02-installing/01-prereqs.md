...
**Important:** Support for version 2 of the Apicurio Registry Core REST API is deprecated. You can continue to use version 2 of the API with {{site.data.reuse.es_name}} 12.3.x and earlier, but it is recommended that you:
