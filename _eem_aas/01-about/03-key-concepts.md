...
An {{site.data.reuse.egw}} group is a group of {{site.data.reuse.egw}} instances that can be logically grouped and scaled together. When [deploying an {{site.data.reuse.egw}}](../../admin/event-gateways), you can define gateway groups by name, and any {{site.data.reuse.egw}} instances with the same group name are considered a member of that group.
...
**DRAFT COMMENT** Is this required in the saas docs -->
