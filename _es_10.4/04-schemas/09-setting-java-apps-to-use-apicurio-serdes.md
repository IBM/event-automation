...
**Note:** Uncomment lines depending on your authentication settings. Replace:
 ...
 - `<Schema registry endpoint>` with the endpoint address for Apicurio Registry in {{site.data.reuse.es_name}}.
