...
**Note:** Before using the {{site.data.reuse.es_name}} CLI, ensure that you log in to your Kubernetes cluster as a cluster administrator by setting your `kubectl` [context](https://v1-35.docs.kubernetes.io/docs/tasks/access-application-cluster/configure-access-multiple-clusters/){:target="_blank"}.
