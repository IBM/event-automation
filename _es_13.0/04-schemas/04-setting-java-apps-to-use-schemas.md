...
props.put(SerdeConfig.REGISTRY_URL, <schema_registry_endpoint>/apis/registry/v3);
System.setProperty("javax.net.ssl.trustStore", <ca_p12_file_location>);
System.setProperty("javax.net.ssl.trustStorePassword", <ca_p12_password>);
...
//System.setProperty("javax.net.ssl.keyStore", <user_p12_file_location>);
//System.setProperty("javax.net.ssl.keyStorePassword", <user_p12_password>);
...
props.put(AvroSerdeConfig.AVRO_ENCODING, AvroSerdeConfig.AVRO_BINARY);
...
For more information about the configuration keys and values to use with the Apicurio Registry `serdes` library, see the [Apicurio Registry documentation](https://www.apicur.io/registry/docs/apicurio-registry/3.3.x/index.html){:target="_blank"}.
