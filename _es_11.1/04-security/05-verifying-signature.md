...
- On the computer where the command-line tools are installed, copy the following version-specific text block exactly as shown into a text editor, and save it in a file named `acecc-public.gpg`. The following text block represents the {{site.data.reuse.es_name}}-certified container public key in the GNU Privacy Guard format.
  ...
  ![Event Streams 11.1.5 icon]({{ 'images' | relative_url }}/11.1.5.svg "In Event Streams 11.1.5")  In {{site.data.reuse.es_name}} versions 11.1.5 and later:
  ...
  In {{site.data.reuse.es_name}} versions 11.1.2, 11.1.3, and 11.1.4:
...
4. Verify that the CASE archive and images `.csv` files have been generated for the {{site.data.reuse.es_name}} and the {{site.data.reuse.icpfs}}. For example, ensure you have the following files for the {{site.data.reuse.es_name}} along with files generated for the {{site.data.reuse.icpfs}} CASE.
...
1. Import the {{site.data.reuse.es_name}}-certified container public key on the computer where you saved the public key to a file as described in the [Before you begin](#before-you-begin) section.
    ...
    - ![Event Streams 11.1.5 icon]({{ 'images' | relative_url }}/11.1.5.svg "In Event Streams 11.1.5") If you are running {{site.data.reuse.es_name}} versions 11.1.5 and later, run the following command:
