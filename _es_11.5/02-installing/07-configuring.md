...
For more information about configuration options, see [configuring the Kafka Exporter](https://strimzi.io/docs/operators/0.43.0/deploying.html#proc-metrics-kafka-deploy-options-str){:target="_blank"}.
