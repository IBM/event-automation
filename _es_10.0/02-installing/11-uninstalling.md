...
You can remove an {{site.data.reuse.es_name}} instance by using the `oc` utility or the {{site.data.reuse.openshift_short}} web console.
You can also remove the {{site.data.reuse.es_name}} operator itself.


## Uninstalling an {{site.data.reuse.es_name}} instance

### Uninstalling using the {{site.data.reuse.openshift_short}} web console
To delete an {{site.data.reuse.es_name}} instance:
...
You can delete an {{site.data.reuse.es_name}} installation using the `oc` command line tool:

1. {{site.data.reuse.openshift_cli_login}}
2. Ensure you are using the project where your {{site.data.reuse.es_name}} instance is located:
`oc project <project_name>`
2. Run the following command to display the {{site.data.reuse.es_name}} instances:
`oc get eventstreams`
...
## Uninstalling an {{site.data.reuse.es_name}} operator
...
6. Click ![More options icon](../../../images/more_options.png "More options icon at end of each row."){:height="30px" width="15px"} **More options** next to the {{site.data.reuse.es_name}} operator to be deleted to open the actions menu.
...
## Removing {{site.data.reuse.es_name}} Custom Resoure Definitions
The {{site.data.reuse.es_name}} Custom Resource Definitions (CRDs) are not deleted automatically. You must manually delete any CRDs that you do not want:
