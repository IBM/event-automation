...
Many more configuration settings are available, but ensure you read the [Apache Kafka documentation](http://kafka.apache.org/28/documentation/){:target="_blank"} thoroughly before experimenting with them.
