...
To manage resources, management beans (MBeans) are used. MBeans represent a resource in the JVM. There are specific [MBean attributes](https://kafka.apache.org/42/operations/monitoring/){:target="_blank"} you can use with Kafka.
...
3. Click **View connection details** tile.
...
For more information, see [Kubernetes Secrets](https://v1-35.docs.kubernetes.io/docs/concepts/configuration/secret/#using-secrets-as-files-from-a-pod){:target="_blank"}.
