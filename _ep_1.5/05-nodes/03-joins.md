...
1. Optional: You can add multiple join conditions on the primary key. To add another join condition on the primary key, click **Add another join condition**. Then, click **Next**.
