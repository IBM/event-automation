...
For more information about scaling up Kafka node pools, see the [Strimzi documentation](https://strimzi.io/docs/operators/0.51.0/deploying#proc-scaling-up-node-pools-str){:target="_blank"}.
...
**Note:** Only a [selected subset](https://strimzi.io/docs/operators/0.51.0/configuring.html#con-common-configuration-jvm-reference){:target="_blank"} of the available JVM options can be configured.
