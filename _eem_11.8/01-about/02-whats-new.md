...
{: #documentation-highlighting-differences-between-versions-1182}

Any difference in features or behavior that is introduced by {{site.data.reuse.eem_name}} 11.8.2 compared to 11.8.1 or earlier is highlighted in this documentation by using the following graphic: ![Event Endpoint Management 11.8.2 icon]({{ 'images' | relative_url }}/11.8.2.svg "In Event Endpoint Management 11.8.2 and later.")

### Security and bug fixes
{: #security-and-bug-fixes-1182}

{{site.data.reuse.eem_name}} release 11.8.2 contains security and bug fixes.
...
Any difference in features or behavior that is introduced by {{site.data.reuse.eem_name}} 11.8.1 compared to 11.8.0 is highlighted in this documentation by using the following graphic: ![Event Endpoint Management 11.8.1 icon]({{ 'images' | relative_url }}/11.8.1.svg "In Event Endpoint Management 11.8.1 and later.")
...
- **Options** are now called **Virtual topics**. Previously, the term **option** was used for event endpoints from the perspective of authors (Kafka administrators). To avoid confusion, the same term is now used for event endpoints from all perspectives. 
- **Event endpoints** are now called **Virtual topics**. Previously, the term **event endpoint** was used for options that were published to the catalog.
...
{{site.data.reuse.eem_name}} 11.8.0 introduces an [integration with {{site.data.reuse.wm_portal_long}}](../../dpo-integration/overview) v12.1.1.2 or later. You can now publish virtual topics to [{{site.data.reuse.wm_portal_short}}](https://www.ibm.com/docs/en/api-connect/software/12.1.1?topic=portal-overview){:target="_blank"} in addition to the {{site.data.reuse.eem_name}} catalog.
