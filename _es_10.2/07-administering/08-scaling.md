...
**Note:** Only a [selected subset](https://strimzi.io/docs/operators/0.19.0/using.html#ref-jvm-options-deployment-configuration-kafka){:target="_blank"} of the available JVM options can be configured.
