...
You can assign specific [user groups](../../about/key-concepts/#user-groups) to edit selected event sources.
...
The **Event source editors** tab on the **User groups** page displays all the event sources that are available to selected user groups. You can use the **User groups** page to [add](#add-group) and [edit](#edit-group-permission-event-sources) user group availability to event sources.
