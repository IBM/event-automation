...
Cluster-level configuration and resources are accessible through the {{site.data.reuse.openshift_short}} [web console](https://docs.openshift.com/container-platform/4.17/web_console/web-console.html){:target="_blank"} and by using the `kubectl` [CLI](https://kubernetes.io/docs/tasks/tools/){:target="_blank"}.
