...
The next step is to provide the topic details to create an entry in the catalog. Add the EMEA orders topic created in the previous tutorial to the catalog as follows.

**Note:** You can also apply the same steps for the EMEA large orders topic, or for any other topic.
...
1. Add a description of the events generated by your processing flow.
   ...
   For example: Events from the EMEA region recorded by the order management system.
