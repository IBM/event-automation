...
You can also [delete](#deleting-an-event-source) your event source from this page. <!-- DRAFT COMMENT: In SW this sentence continues with: "or [import this event source for use with {{site.data.reuse.apic_long}}](../../integrating-with-apic/generate-asyncapi/)" we can add this back if/when apic integration is supported in ipaas. -->
