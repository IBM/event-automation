...
- He is guided to add appropriate metadata to [describe his topic](../../describe/managing-source-topics/#overview-information).
- He adds management capabilities to make sure that when socialized, his topic has [security](../../describe/security-controls) and [event data controls](../../describe/event-data-controls) applied to enforce rules of engagement on any clients that use his topic. In this case, he [redacts](../../describe/event-data-controls/#consume-redaction) sensitive data when clients consume events.
