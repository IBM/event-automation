...
-----------------------------------------------|------------------|------------------|-----------------------|---------------------|---------|
11.0.4  | 11.0.4  | v11.0  | 11.0.5 | {{site.data.reuse.openshift}} versions 4.10 to 4.12, all fix levels (see [support dates](https://access.redhat.com/support/policy/updates/openshift#dates){:target="_blank"}). <br> <br> Managed OpenShift services on cloud platforms (PaaS): <br>- Red Hat OpenShift on IBM Cloud <br> - Azure Red Hat OpenShift <br> - Red Hat OpenShift Service on AWS <br> <br> **Note:** [AWS ECS Fargate](https://aws.amazon.com/fargate/){:target="_blank"} is not supported. <br> <br> OpenShift on cloud infrastructure (IaaS): <br> - IBM Cloud <br> - Microsoft Azure <br> - Amazon Web Services <br> <br> Kubernetes platforms that support the Red Hat Universal Base Images (UBI) containers, versions 1.23 to 1.28 | - Linux 64-bit (x86_64) systems | 
