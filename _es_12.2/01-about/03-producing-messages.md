...
Many more configuration settings are available, but ensure that you read the [Apache Kafka documentation](https://kafka.apache.org/40/documentation.html){:target="_blank"} thoroughly before experimenting with them.
...
- [Apache Kafka documentation](https://kafka.apache.org/40/documentation.html){:target="_blank"}
