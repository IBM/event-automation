...
A group of users that have access to specific actions such as viewing options, editing event sources, and maintaining clusters. [User groups are defined by an external identity provider](../../security/groups/), and group membership is sent as part of the login process.
