...
- If you want to use the CLI to set up geo-replication, ensure you have the [Kubernetes CLI installed](https://v1-35.docs.kubernetes.io/docs/tasks/tools/){:target="_blank"}.
