...
2. Run the following command to download, validate, and extract the {{site.data.reuse.es_name}} CASE.
   ...
   - Success
   Download of CASE: ibm-eventstreams, version: 12.2.2 is complete
   ```
...
3. Verify that the CASE and images (`.csv`) files have been generated for {{site.data.reuse.es_name}}.
   ...
   │   │           ├── charts
   │   │           ├── ibm-eventstreams-12.2.2-airgap-metadata.yaml
   │   │           ├── ibm-eventstreams-12.2.2-charts.csv
   │   │           ├── ibm-eventstreams-12.2.2-images.csv
   │   │           ├── ibm-eventstreams-12.2.2.tgz
   │   │           └── resourceIndexes
