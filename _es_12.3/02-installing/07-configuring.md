...
For more information, see the [managing node pool IDs](https://strimzi.io/docs/operators/0.51.0/deploying#proc-managing-node-pools-ids-str){:target="_blank"}.
...
For more information about the limitations, see the [Strimzi KRaft documentation](https://strimzi.io/docs/operators/0.51.0/deploying#kraft_limitations){:target="_blank"}.
...
For more information about logging, see the [Kafka logging reference](https://strimzi.io/docs/operators/0.51.0/configuring.html#property-kafka-logging-reference){:target="_blank"}.
...
**Important:** The `oauth` authentication type is deprecated and will be removed in a future release. Use the `custom` authentication type instead.
...
The snippet provided shows a configuration containing the most commonly used properties. For information about further OAuth properties, see [Using OAuth 2.0 token-based authentication](https://strimzi.io/docs/operators/0.51.0/deploying.html#assembly-oauth-security-str){:target="_blank"}.
...
The snippet provided shows a configuration containing the most commonly used properties. For information about further OAuth properties, see [configuring an OAuth 2.0 authorization server](https://strimzi.io/docs/operators/0.51.0/deploying.html#assembly-oauth-security-str){:target="_blank"}.
...
- [Kafka JMX metrics configuration](https://strimzi.io/docs/operators/0.51.0/deploying.html#assembly-metrics-str){:target="_blank"}
- [Prometheus JMX metrics configuration](https://strimzi.io/docs/operators/0.51.0/configuring.html#con-common-configuration-prometheus-reference){:target="_blank"}
