...
1. Ensure you have [cluster logging](https://docs.openshift.com/container-platform/4.16/logging/cluster-logging-deploying.html){:target="_blank"} installed.
...
3. Navigate to the Kibana homepage on your cluster.
   ...
   {{site.data.reuse.openshift_ui_login}} Then follow the instructions to navigate to [the cluster logging's Kibana homepage](https://docs.openshift.com/container-platform/4.16/logging/log_visualization/logging-kibana.html#cluster-logging-visualizer-kibana_logging-kibana){:target="_blank"}.
