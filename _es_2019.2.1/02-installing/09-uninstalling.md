...
4. Optional: If you enabled persistence during installation, you also need to manually remove  [PersistentVolumes](https://www.ibm.com/support/knowledgecenter/SSBS6K_3.2.0/manage_cluster/delete_volume.html){:target="_blank"} and [PersistentVolumeClaims](https://www.ibm.com/support/knowledgecenter/SSBS6K_3.2.0/manage_cluster/delete_app_volume.html){:target="_blank"}.
