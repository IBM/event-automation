...
- If you want to use the CLI to set up geo-replication, ensure you have the [{{site.data.reuse.es_name}} CLI installed](../../installing/post-installation/#installing-the-command-line-interface-cli).
