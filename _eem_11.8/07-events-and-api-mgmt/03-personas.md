...
- Event author: the owner of a [source topic](../../about/key-concepts/#source-topic), who wants to share the events it contains across multiple lines of business. They document their source topic, define [rules of engagement](../../integrating-with-apic/apic-eem-concepts/#policy) on it and publish [virtual topics](../../about/key-concepts/#virtual-topic) to a catalog for socialization, making the events available to others. This aligns with the API developer persona.
