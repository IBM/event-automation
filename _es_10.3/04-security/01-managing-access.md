...
Access for groups and users is managed through IAM teams. If you have not previously created any teams, the admin user credentials can be used to [set up a team](https://www.ibm.com/docs/en/cloud-paks/foundational-services/3.19?topic=users-managing-teams){:target="_blank"}.
