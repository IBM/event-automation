...
1. Log in to the {{site.data.reuse.eem_name}} UI with a user that has administrator privileges.
2. In the navigation pane, click **Manage > External applications**.

The page displays a tile for the integration with {{site.data.reuse.wm_portal_long}} 12.1.1.2 or later.

## {{site.data.reuse.wm_portal_long}} v12.1.1.2 or later
...
The tile shows the connection status between Event Endpoint Management and {{site.data.reuse.wm_portal_short}} v12.1.1.2 or later:
...
To add {{site.data.reuse.wm_portal_long}} as an external application, follow the instructions in [Configure {{site.data.reuse.eem_name}} and {{site.data.reuse.wm_portal_long}} 12.1.1.2 or later ](../../dpo-integration/configure-eem-for-dpo-apic12/).
