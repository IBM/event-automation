...
3. Create a [namespace](https://www.ibm.com/support/knowledgecenter/SSBS6K_3.1.1/user_management/create_project.html) where you will install your {{site.data.reuse.es_name}} instance.
