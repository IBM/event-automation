...
The license usage of {{site.data.reuse.es_name}} is collected by the {{site.data.reuse.icpfs}} License Service, which provides the service that tracks the licensed containers and their resource usage based on the product use. Ensure you install the License Service as described in the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/2022.2?topic=administering-deploying-license-service){:target="_blank"}.
