...
![Event Streams 11.1.5 icon]({{ 'images' | relative_url }}/11.1.5.svg "In Event Streams 11.1.5"){{site.data.reuse.es_name}} version 11.1.5 includes [Apache Kafka Raft (KRaft)](https://cwiki.apache.org/confluence/display/KAFKA/KIP-500%3A+Replace+ZooKeeper+with+a+Self-Managed+Metadata+Quorum){:target="_blank"} as a Technology Preview feature.
...
- You can only access the {{site.data.reuse.es_name}} UI by using {{site.data.reuse.icpfs}} Identity and Access Management (IAM).
