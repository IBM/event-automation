...
- {{site.data.reuse.es_name}} version 10.2.1 with operator version 2.2.6 includes Kafka release 2.6.3, and supports the use of all Kafka interfaces.
- {{site.data.reuse.es_name}} version 10.2.1 includes Kafka release 2.6.2, and supports the use of all Kafka interfaces.
- {{site.data.reuse.es_name}} version 10.2.0 includes Kafka release 2.6.0, and supports the use of all Kafka interfaces.
