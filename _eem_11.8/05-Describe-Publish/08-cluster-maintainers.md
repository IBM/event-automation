...
1. Select the **Cluster maintainers** tab.
...
1. Click the **Edit** icon ![edit icon]({{ 'images' | relative_url }}/rename.svg "Diagram showing edit icon."){:height="30px" width="15px"} for the group that you want to edit. The **Edit clusters** pane is displayed.
    - To add clusters, click **Add clusters**. The **Add clusters** window is displayed.
   
      Select the clusters that you want, then click **Save**.   

    - To remove clusters, click the **Delete** icon ![trash icon]({{ 'images' | relative_url }}/trashcan.svg "Diagram showing remove topic icon."){:height="30px" width="15px"}.
1. Click **Save**.
