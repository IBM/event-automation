...
Connections to {{site.data.reuse.eem_name}} are [secured using TLS](../config-tls). TLS certificates are generated during installation, or you can [use your own certificates](../config-tls#custom-ca-certificate).
