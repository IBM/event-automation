...
{{site.data.reuse.es_name}} 10.4.0 is supported on the {{site.data.reuse.openshift}}. Version 10.4.0 is installed by the {{site.data.reuse.es_name}} operator 2.4.0, and includes Kafka version 2.8.0.
