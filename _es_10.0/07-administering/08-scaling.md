...
For example to configure the Schema Registry to have a memory request set to `4GB` and limit set to `8GB`:
...
**Note:** Only a [selected subset](https://strimzi.io/docs/operators/0.18.0/using.html#ref-jvm-options-deployment-configuration-kafka) of the available JVM options can be configured.
