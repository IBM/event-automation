---
title: "Unable to subscribe to a virtual topic in IBM API Connect Developer Portal v12.1.1.2 or later"
...
Users cannot consume a virtual topic or produce to a virtual topic from their Kafka clients that are configured using the information in {{site.data.reuse.wm_portal_short}}.
...
4. Review the event data controls configured on the virtual topic to ensure that they are not blocking access.