...
## Logging out
Logging out of {{site.data.reuse.es_name}} does not log you out of your session entirely. To log out, you must first log out of your {{site.data.reuse.icpcs}} session, and then log out of your {{site.data.reuse.es_name}} session.
