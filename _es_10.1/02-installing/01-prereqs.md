...
{{site.data.reuse.es_name}} 10.1.0 is supported on the {{site.data.reuse.openshift}}.

Version 10.1.0 is installed by the {{site.data.reuse.es_name}} operator 2.1.0, and includes Kafka version 2.6.0. For an overview of supported component and platform versions, see the [support matrix]({{ 'support/matrix/#event-streams' | relative_url }}).
