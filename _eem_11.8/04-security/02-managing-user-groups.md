...
- **Virtual topic viewers**: ![Virtual topic editor pill]({{ 'images' | relative_url }}/EditorText.svg "Virtual topic editor pill.") 
- **Source topic editor**:  ![Event source editor pill]({{ 'images' | relative_url }}/EditorText.svg "Source topic editor pill.") 
- **Cluster maintainer**:   ![Cluster maintainer pill]({{ 'images' | relative_url }}/MaintainerText.svg "Cluster maintainer pill.") 
...
Virtual topic viewers are a group of users that, in addition to existing public virtual topics, can also view and subscribe to selected virtual topics in the catalog. Users can view and subscribe to the [virtual topics that are assigned](../../describe/user-groups/) to their user group. 

Virtual topic viewers can:
- View virtual topics.
- Create applications to subscribe to virtual topics.

Virtual topic viewers cannot:
- Create, publish, or delete virtual topics.
- Manage source topics (add or delete topics, edit topic information, or manage access).
- Manage clusters (add, delete, or edit).

### Source topic editors
{: #source-topic-editors}

Source topic editors can update [source topic information](../../describe/managing-source-topics/#overview-information) and [manage](../../describe/managing-virtual-topics/) virtual topics for the source topics that are added to their user group.

Source topic editors can:
- Create, publish, and delete virtual topics.
- Edit source topic information.
- Revoke subscriptions.
- Manage access requests.

Source topic editors cannot:
- Delete source topics.
- Change source topic editors.
...
When a user creates an application, they can add other user groups as **application collaborators**, who can view and edit the application.

Application collaborators can:
- Subscribe to virtual topics with the application.
- Edit application details.

Application collaborators cannot:
- Delete applications.
...
**Important:** If you [access user groups by using a custom identifier](#access-user-groups), additional configuration is required to ensure that Admin API users have their groups read and see the correct virtual topics in the catalog. This is because a custom property in OIDC is used instead of the unique user subject (the owner of the token).
...
- Application collaborators will not see the applications that they were previously collaborators on, but their application credentials will still work.
- If group visibility is enabled again later, all previously defined groups become active again. 

### Before you begin

Ensure that you notify all impacted users before you disable user groups.
