...
1. Verify that the CA certificate for this control is [uploaded](../../admin/ca-certs). If not then you must upload the CA certificate before you create the control.
...
It is your responsibility to update the CA certificates before they expire. Follow the instructions in [Managing CA certificates](../../admin/ca-certs) to update your CA certificates.
