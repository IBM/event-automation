...
The Topic operator uses Kubernetes [finalizers](https://v1-35.docs.kubernetes.io/docs/concepts/overview/working-with-objects/finalizers/){:target="_blank"} to ensure topics are deleted from Kafka before deleting `KafkaTopic` custom resources.
...
```
For more information, see [Removing finalizers on topics](https://strimzi.io/docs/operators/1.0.0/full/deploying.html#con-removing-topic-finalizers-str){:target="_blank"}.
...
## Uninstalling {{site.data.reuse.es_name}} cluster-scoped resources
{: #uninstalling-crds}
