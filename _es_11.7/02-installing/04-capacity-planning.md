...
For more information about these settings, see [the Kafka documentation](https://kafka.apache.org/39/documentation/#configuration){:target="_blank"}.
