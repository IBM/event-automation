...
- {{site.data.reuse.es_name}} version 11.0.4 includes Kafka release 3.2.0, and supports the use of all Kafka interfaces.
- {{site.data.reuse.es_name}} version 11.0.3 includes Kafka release 3.2.0, and supports the use of all Kafka interfaces.
...
- A schema registry to support the definition and enforcement of message formats between producers and consumers. {{site.data.reuse.es_name}} includes the open-source [Apicurio Registry](https://www.apicur.io/registry/docs/apicurio-registry/2.2.x/index.html){:target="_blank"} for managing schemas.
