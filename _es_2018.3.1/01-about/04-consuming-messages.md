...
Many more configuration settings are available, but ensure you read the [Apache Kafka documentation](http://kafka.apache.org/documentation/) thoroughly before experimenting with them.
