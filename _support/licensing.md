...
| &nbsp; | [**L-KCVZ-JL5CRM**](https://www.ibm.com/support/customer/csol/terms/?id=L-KCVZ-JL5CRM&lc=en#detail-document){:target="_blank"} | - {{site.data.reuse.es_name}} 11.5.0 and later <br><br> - {{site.data.reuse.eem_name}} 11.3.0 to 11.3.2 <br><br> - {{site.data.reuse.ep_name}} 1.2.0 and later  | &nbsp; |  &nbsp; |
