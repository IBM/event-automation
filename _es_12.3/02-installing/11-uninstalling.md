...
```
For more information, see [Removing finalizers on topics](https://strimzi.io/docs/operators/0.51.0/full/deploying.html#con-removing-topic-finalizers-str){:target="_blank"}.
