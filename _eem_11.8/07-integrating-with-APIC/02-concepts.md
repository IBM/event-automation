...
All [virtual topics](../../about/key-concepts/#virtual-topic) in {{site.data.reuse.eem_name}} are enforced by an {{site.data.reuse.egw}}.
...
Currently, there is no direct equivalent concept in {{site.data.reuse.eem_name}}. All published [virtual topics](../../about/key-concepts/#virtual-topic) are [enforced](#enforced-api).
...
- Draft - maps to the virtual topic 'Unpublished' state.
- Staged - maps to the virtual topic 'Unpublished' state.
- Published - maps to the virtual topic 'Published' state.
- Deprecated - maps to the virtual topic 'Archived' state.
- Retired - has no equivalent virtual topic lifecycle state in {{site.data.reuse.eem_name}}.
