...
- [Kafka JMX metrics configuration](https://strimzi.io/docs/operators/0.45.0/deploying.html#assembly-metrics-str){:target="_blank"}
- [Prometheus JMX metrics configuration](https://strimzi.io/docs/operators/0.45.0/configuring.html#con-common-configuration-prometheus-reference){:target="_blank"}
