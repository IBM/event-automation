...
Find out more about the OpenTelemetry metrics emitted by the {{site.data.reuse.eem_manager}}, the {{site.data.reuse.egw}}, and [{{site.data.reuse.wm_portal_long}}](../../dpo-integration/overview).
...
| resource_count | LongGauge | Number of resources created. The resources that are included in this count are: Virtual topics and {{site.data.reuse.egw}}s. |
