...
1. Click ![More options icon]({{ 'images' | relative_url }}/more_options.png "More options icon at end of each row."){:height="30px" width="15px"} **More options** on the virtual topic that you want to use in {{site.data.reuse.apic_short}}.
...
**Note:** You cannot export virtual topics that contain approval control to {{site.data.reuse.apic_short}}. 
