...
Many more configuration settings are available, but ensure that you read the [Apache Kafka documentation](http://kafka.apache.org/32/documentation/){:target="_blank"} thoroughly before experimenting with them.
