...
excerpt: "To provide access to your socialized event endpoints, find out how to install and configure Gateways and Gateway groups on the same cluster as the {{site.data.reuse.eem_manager}} instance."
