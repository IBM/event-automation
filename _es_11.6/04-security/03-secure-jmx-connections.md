...
To manage resources, management beans (MBeans) are used. MBeans represent a resource in the JVM. There are specific [MBean attributes](https://kafka.apache.org/39/documentation/#remote_jmx){:target="_blank"} you can use with Kafka.
