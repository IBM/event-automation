...
**Note:** The previous schema registry in {{site.data.reuse.es_name}} was deprecated in version 10.1.0 and is not an available option for schemas in {{site.data.reuse.es_name}} version 10.5.0 and later. If you are upgrading to {{site.data.reuse.es_name}} version 10.2.0 or later from an earlier version and you are using the deprecated registry option previously used for schemas, you can [migrate](../../installing/migrating-to-apicurio/) to the Apicurio Registry.
