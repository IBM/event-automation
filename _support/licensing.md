...
<!-- | {{site.data.reuse.ipaas_name}} 12.1 | [**L-HRAV-KRAE8U**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-HRAV-KRAE8U){:target="_blank"} | - {{site.data.reuse.es_name}} 12.3.1 and later <br><br> - {{site.data.reuse.eem_name}} 11.7.4 and later <br><br> - {{site.data.reuse.ep_name}} 1.5.2 and later <br><br>| - `WebMethodsHybridIntegrationNonProduction`  <br> <br> - `WebMethodsHybridIntegrationProduction` <br> <br> - `WebMethodsHybridIntegrationDevelopment` <br> <br> - `WebMethodsHybridIntegrationDisasterRecovery` <br> <br> **Note:** `WebMethodsHybridIntegrationDisasterRecovery` is only applicable to {{site.data.reuse.es_name}}. For more information, see [disaster recovery licensing](#disaster-recovery-licensing). | - {{site.data.reuse.es_name}} and {{site.data.reuse.ep_name}}: `VIRTUAL_PROCESSOR_CORE` <br> <br> - {{site.data.reuse.eem_name}}: `MONTHLY_API_CALL` | -->
...
----------|------------------------|-----------------------------------------|--------------------------------------|--------------------------------------------|
| {{site.data.reuse.cp4i}} 16.2.0 Full <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.2.0?topic=planning-licensing){:target="_blank"}. | [**L-VEMB-RABZSN**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-VEMB-RABZSN){:target="_blank"} | - {{site.data.reuse.es_name}} 13.0.0 and later <br> <br> - {{site.data.reuse.eem_name}} 11.8.0 and later | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> <br> - `CloudPakForIntegrationDisasterRecovery` <br> <br> **Note:** `CloudPakForIntegrationDisasterRecovery` is only applicable to {{site.data.reuse.es_name}}. For more information, see [disaster recovery licensing](#disaster-recovery-licensing). | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
| {{site.data.reuse.cp4i}} 16.2.0 Reserved <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.2.0?topic=planning-licensing){:target="_blank"}. | [**L-UHEB-WGGTYF**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-UHEB-WGGTYF){:target="_blank"} | - {{site.data.reuse.es_name}} 13.0.0 and later <br> <br> - {{site.data.reuse.eem_name}} 11.8.0 and later | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> <br> - `CloudPakForIntegrationDisasterRecovery` <br> <br> **Note:** `CloudPakForIntegrationDisasterRecovery` is only applicable to {{site.data.reuse.es_name}}. For more information, see [disaster recovery licensing](#disaster-recovery-licensing). | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
| {{site.data.reuse.cp4i}} 16.2.0 API Calls <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.2.0?topic=planning-licensing){:target="_blank"}. | [**L-QXEH-527JUB**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-QXEH-527JUB){:target="_blank"} | <br> <br> - {{site.data.reuse.eem_name}} 11.8.0 and later|   -`CloudPakForIntegrationProduction` | `MONTHLY_API_CALL` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}. <br> <br> Setting this metric and the related license ID configures the usage-based license. <br> <br> **Note:** For more information about what is charged when using the `MONTHLY_API_CALL` license reporting metric with {{site.data.reuse.eem_name}}, see [the {{site.data.reuse.eem_name}} usage-based pricing example]({{ 'eem/installing/planning/#example-deployment-usage-based-pricing' | relative_url }}).
| {{site.data.reuse.cp4i}} 16.1.3 including the Cloud Pak for Integration Agent and {{site.data.reuse.es_name}} DR Full <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.3?topic=planning-licensing){:target="_blank"}. | [**L-EEPY-X55F4E**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-EEPY-X55F4E){:target="_blank"} | - {{site.data.reuse.es_name}} 12.3.0 and 12.3.1 <br> <br> - {{site.data.reuse.eem_name}} 11.7.3 and 11.7.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> <br> - `CloudPakForIntegrationDisasterRecovery` <br> <br> **Note:** `CloudPakForIntegrationDisasterRecovery` is only applicable to {{site.data.reuse.es_name}}. For more information, see [disaster recovery licensing](#disaster-recovery-licensing). | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.3 including the Cloud Pak for Integration Agent and {{site.data.reuse.es_name}} DR Reserved <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.3?topic=planning-licensing){:target="_blank"}. | [**L-YKPH-DG8FFX**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-YKPH-DG8FFX){:target="_blank"} | - {{site.data.reuse.es_name}} 12.3.0 and 12.3.1 <br> <br> - {{site.data.reuse.eem_name}} 11.7.3 and 11.7.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> <br> - `CloudPakForIntegrationDisasterRecovery` <br> <br> **Note:** `CloudPakForIntegrationDisasterRecovery` is only applicable to {{site.data.reuse.es_name}}. For more information, see [disaster recovery licensing](#disaster-recovery-licensing). | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.3 Full <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.3?topic=planning-licensing){:target="_blank"}. | [**L-SJZL-NMUUCT**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-SJZL-NMUUCT){:target="_blank"} | - {{site.data.reuse.es_name}} 12.2.0 to 12.3.1 <br> <br> - {{site.data.reuse.eem_name}} 11.7.0 to 11.7.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br>  | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.3 Reserved <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.3?topic=planning-licensing){:target="_blank"}. | [**L-JNME-56SJTB**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-JNME-56SJTB){:target="_blank"} | - {{site.data.reuse.es_name}} 12.2.0 to 12.3.1 <br> <br> - {{site.data.reuse.eem_name}} 11.7.0 to 11.7.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.3 API Calls <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.3?topic=planning-licensing){:target="_blank"}. | [**L-YPZT-N6DZVW**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-YPZT-N6DZVW){:target="_blank"} | <br> <br> - {{site.data.reuse.eem_name}} 11.7.0 to 11.7.4|   -`CloudPakForIntegrationProduction` | `MONTHLY_API_CALL` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}. <br> <br> Setting this metric and the related license ID configures the usage-based license. <br> <br> **Note:** For more information about what is charged when using the `MONTHLY_API_CALL` license reporting metric with {{site.data.reuse.eem_name}}, see [the {{site.data.reuse.eem_name}} usage-based pricing example]({{ 'eem/installing/planning/#example-deployment-usage-based-pricing' | relative_url }}).
{{site.data.reuse.cp4i}} 16.1.2 Full <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.2?topic=planning-licensing){:target="_blank"}. | [**L-CYPF-CRPF3H**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-CYPF-CRPF3H){:target="_blank"} | - {{site.data.reuse.es_name}} 11.8.0 to 12.1.0 <br> <br> - {{site.data.reuse.eem_name}} 11.6.0 to 11.6.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br>  | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.2 Reserved <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.2?topic=planning-licensing){:target="_blank"}. | [**L-MQQP-KBWMYE**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-MQQP-KBWMYE){:target="_blank"} | - {{site.data.reuse.es_name}} 11.8.0 to 12.1.0 <br> <br> - {{site.data.reuse.eem_name}} 11.6.0 to 11.6.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.2 API Calls <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.2?topic=planning-licensing){:target="_blank"}. | [**L-JVUW-LSTB9R**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-JVUW-LSTB9R){:target="_blank"} | <br> <br> - {{site.data.reuse.eem_name}} 11.6.0 to 11.6.4|   -`CloudPakForIntegrationProduction` | `MONTHLY_API_CALL` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}. <br> <br> Setting this metric and the related license ID configures the usage-based license. <br> <br> **Note:** For more information about what is charged when using the `MONTHLY_API_CALL` license reporting metric with {{site.data.reuse.eem_name}}, see [the {{site.data.reuse.eem_name}} usage-based pricing example]({{ 'eem/installing/planning/#example-deployment-usage-based-pricing' | relative_url }}).
...
{{site.data.reuse.cp4i}} 16.1.0 Full <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.0?topic=planning-licensing){:target="_blank"}. | [**L-JTPV-KYG8TF**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-JTPV-KYG8TF){:target="_blank"} | - {{site.data.reuse.es_name}} 11.4.0 to 12.3.1 <br> <br> - {{site.data.reuse.eem_name}} 11.2.0 to 11.7.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> <br> **Note:** The `CloudPakForIntegrationDevelopment` is available for {{site.data.reuse.es_name}} 11.5.1 and {{site.data.reuse.eem_name}} 11.4.0, and all later versions.  | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.0 Reserved <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.0?topic=planning-licensing){:target="_blank"}. | [**L-BMSF-5YDSLR**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-BMSF-5YDSLR){:target="_blank"} | - {{site.data.reuse.es_name}} 11.4.0 to 12.3.1 <br> <br> - {{site.data.reuse.eem_name}} 11.2.0 to 11.7.4 | -`CloudPakForIntegrationNonProduction`  <br> <br> -`CloudPakForIntegrationProduction` <br> <br> - `CloudPakForIntegrationDevelopment` <br> <br> **Note:** The `CloudPakForIntegrationDevelopment` is available for {{site.data.reuse.es_name}} 11.5.1 and {{site.data.reuse.eem_name}} 11.4.0, and all later versions. | `VIRTUAL_PROCESSOR_CORE` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}.
{{site.data.reuse.cp4i}} 16.1.0 API Calls <br> <br> For more information, see the [{{site.data.reuse.cp4i}} documentation](https://www.ibm.com/docs/en/cloud-paks/cp-integration/16.1.0?topic=planning-licensing){:target="_blank"}. | [**L-FTGN-WUM5C5**](https://www14.software.ibm.com/cgi-bin/weblap/lap.pl?popup=Y&li_formnum=L-FTGN-WUM5C5){:target="_blank"} | <br> <br> - {{site.data.reuse.eem_name}} 11.2.0 to 11.7.4 | -`CloudPakForIntegrationProduction` | `MONTHLY_API_CALL` <br><br> **Note:** Only an option for {{site.data.reuse.eem_name}}. <br> <br> Setting this metric and the related license ID configures the usage-based license. <br> <br> **Note:** For more information about what is charged when using the `MONTHLY_API_CALL` license reporting metric with {{site.data.reuse.eem_name}}, see [the {{site.data.reuse.eem_name}} usage-based pricing example]({{ 'eem/installing/planning/#example-deployment-usage-based-pricing' | relative_url }}).
...
<!--
### Licensing {{site.data.reuse.es_name}}, {{site.data.reuse.eem_name}}, and {{site.data.reuse.ep_name}} within {{site.data.reuse.ipaas_name}}

The {{site.data.reuse.es_name}}, {{site.data.reuse.eem_name}}, and {{site.data.reuse.ep_name}} capabilities are also included in {{site.data.reuse.ipaas_name}}.

{{site.data.reuse.ipaas_name}} uses Resource Units (RU) as its licensing metric, with different consumption rates for production, non-production, and [disaster recovery](#disaster-recovery-licensing) deployments. See the [license table](#ibm-webmethods-hybrid-integration-license-information) for the applicable License IDs, and refer to the license information page for details about how RUs are calculated and consumed.
-->
...
<!--
Disaster recovery licensing is available when deployed with the correct license:

- For **{{site.data.reuse.cp4i}}**, see the [license table](#ibm-cloud-pak-for-integration-license-information) for disaster recovery-enabled licenses that include the `CloudPakForIntegrationDisasterRecovery` license use option. Disaster recovery instances use a 2:1 ratio, where 2 VPCs in the disaster recovery instance count as 1 VPC for licensing purposes.

- For **{{site.data.reuse.ipaas_name}}**, see the [license table](#ibm-webmethods-hybrid-integration-license-information) for disaster recovery-enabled licenses that include the `WebMethodsHybridIntegrationDisasterRecovery` license use option. Disaster recovery instances use a 1:6 ratio, where you consume 6 {{site.data.reuse.ipaas_name}} RUs for 1 {{site.data.reuse.es_name}} VPC.

**Examples:**

- If you have an {{site.data.reuse.cp4i}} disaster recovery instance with 12 chargeable cores, the disaster recovery instance uses a 2:1 ratio, and you would require 6 {{site.data.reuse.cp4i}} VPCs.
- If you have an {{site.data.reuse.ipaas_name}} disaster recovery instance with 12 chargeable cores, the disaster recovery instance uses a 1:6 ratio, and you would require 2 {{site.data.reuse.ipaas_name}} RUs.

To create a disaster recovery instance identical to your production instance, you can copy the configuration you created for your production instance, and change the license configuration to use the appropriate disaster recovery license use option from the [{{site.data.reuse.cp4i}} license table](#ibm-cloud-pak-for-integration-license-information) or [{{site.data.reuse.ipaas_name}} license table](#ibm-webmethods-hybrid-integration-license-information).
...
- During normal operation, only MirrorMaker 2.0 can connect to the disaster recovery instance for one-way replication.
- If the production instance becomes unavailable, producers, consumers, and connectors can temporarily connect to the disaster recovery instance until the production instance is restored.
- The licensing ratio applies to the containers of Kafka brokers and MirrorMaker 2.0 nodes running in the disaster recovery instance.
-->
