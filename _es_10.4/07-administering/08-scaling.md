...
**Note:** Only a [selected subset](https://strimzi.io/docs/operators/0.22.0/using.html#con-common-configuration-jvm-reference){:target="_blank"} of the available JVM options can be configured.
